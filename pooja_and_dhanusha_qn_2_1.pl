...
% Old rule case 1: any male child precedes any female child.
precedes_old(A, B) :-
    child_of_queen(A),
    child_of_queen(B),
    male(A),
...
% Old rule case 2: between two males, older one precedes younger one.
precedes_old(A, B) :-
    child_of_queen(A),
    child_of_queen(B),
    male(A),
...
% Old rule case 3: between two females, older one precedes younger one.
precedes_old(A, B) :-
    child_of_queen(A),
    child_of_queen(B),
    female(A),
